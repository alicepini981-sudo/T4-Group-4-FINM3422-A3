# Data Loading and Cleaning (April 2026 RBA Rates)
...
class YieldCurve:
    ...
    This class is infrastructure: all interest-rate logice
    ...
    def __init__(self, maturities, zero_rates, compounding = "continuous"):
        ...
        Zero_rates : array like
            Annualised zero rates as decimals
        Compounding : str
